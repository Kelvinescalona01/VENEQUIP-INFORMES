...
export default function App() {
  ...
  // Change handler with instant local state update and debounced heavy work.
  // El informe puede incluir fotos y firmas en base64 (varios MB), así que
  // convertirlo a JSON y escribirlo en localStorage en CADA tecla es lo que
  // hacía sentir "lenta" la app y los botones con retraso al pulsarlos.
  // Ahora esa parte pesada se posterga 400ms desde la última tecla, mientras
  // que la actualización visual del campo (setReport) sigue siendo instantánea.
